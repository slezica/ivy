...
const CUSTOM_BLOCK = [
  ...
  '        }',
  '        // E2e build for the Maestro suite: a preview clone with the variant signal',
  '        // unlocking test affordances, plus debuggable so the toolkit harness can',
  '        // run-as into app data (script/toolkit.ts query). JS stays the embedded',
  '        // release bundle either way.',
  '        maestro {',
  '            initWith preview',
  '            signingConfig signingConfigs.debug',
  '            debuggable true',
