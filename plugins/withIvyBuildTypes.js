...
const CUSTOM_BLOCK = [
  ...
  '        }',
  '        // E2e build for the Maestro suite: a preview clone with the variant',
  '        // signal unlocking test affordances, plus debuggable so tooling gets',
  '        // run-as DB access (toolkit query + the upgrade smoke test).',
  '        maestro {',
  '            initWith preview',
  '            signingConfig signingConfigs.debug',
  '            debuggable true',
