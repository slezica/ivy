...
src/components/
  ...
  BookDetails.tsx        → Read-only details view (extras; Close/Edit buttons)
  BookDetailsDialog.tsx  → Viewer/editor pair dialog (lazy extraction on open; library + player menus)
